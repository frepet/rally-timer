export const sv = {
	...
	pendingGatesHeading: 'Väntar på godkännande',
	acceptGate: 'Godkänn',
	rejectGate: 'Neka',
	acceptGateConfirm: (name: string) => `Godkänn grinden "${name}"? Den kan då skicka händelser.`,
	rejectGateConfirm: (name: string) => `Neka grinden "${name}"? Den kan inte skicka händelser.`,
	noPendingGates: 'Inga grindar väntar på godkännande.',
	...
	enableSoundButton: 'Aktivera ljud',
	finishBeepLabel: 'Målpip',
	finishBeepHint: 'Spelar en signal när en bil passerar målgrinden',
...
export const en: typeof sv = {
	...
	pendingGatesHeading: 'Awaiting approval',
	acceptGate: 'Accept',
	rejectGate: 'Reject',
	acceptGateConfirm: (name: string) => `Accept gate "${name}"? It will be able to send events.`,
	rejectGateConfirm: (name: string) => `Reject gate "${name}"? It will not be able to send events.`,
	noPendingGates: 'No gates are awaiting approval.',
	...
	finishBeepLabel: 'Finish beep',
	finishBeepHint: 'Plays a tone when a car passes the finish gate',
	...
	speechStageStarted: 'Stage started',
	speechStageStopped: 'Stage stopped',
	speechGo: 'go',
