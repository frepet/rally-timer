...
class UHFGate:
                ...
                if self.api.ensure_registered():
                    ...
                    if pending:
                        ...
                        if stored > 0:
                            ...
                            logger.info(f"Synced {stored} events (queue: {self.queue.count_pending()})")
    ...
    def run(self):
        ...
        logger.info(f"Polling started. Dedup: {config.dedup_seconds}s, RSSI threshold: {config.rssi_threshold}")
